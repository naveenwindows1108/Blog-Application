        ...
        <div className="col-12 col-md-8 col-lg-6">
          ...
          <div className="auth-card mx-auto mb-4" style={{ maxWidth: '100%' }}>
            ...
            <form onSubmit={handleUpdateEmail}>
              ...
              <button type="submit" className="btn btn-dark w-100 py-2">Update Email</button>
            </form>
          </div>
          ...
          <div className="auth-card mx-auto mb-4" style={{ maxWidth: '100%' }}>
            ...
            <form>
              ...
              <button type="button" className="btn btn-outline-dark w-100 py-2">Update Password</button>
            </form>
          </div>
